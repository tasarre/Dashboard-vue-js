<template>
  <div class="team">
    ...
    <v-card-actions>
      ...
      <div class="overline">Thierno</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
    ...
    <v-list-item>
       <v-list-item-avatar
        ...
        class="mt-n7"
      >
      <v-sheet color="#0D47A1" width="80" height="80" elevation="10">
    ...
    <v-card-actions>
      ...
      <div class="overline">My YB channel</div>
    </v-card-actions>
  </v-card>
      </v-flex>
       <v-flex
        ...
        <v-flex xs12 sm6 md4 lg3 v-for="person in team" :key="person.name">
              <v-card class="text-center ma-3">
                <v-responsive class="pt-4">
                   <v-avatar size="100" class="blue lighten-2">
...
export default {
  ...
  data : () => ({
    team: [
      {name: 'John', role: 'web developer', avatar:'/img1.png'},
      {name: 'Peter', role: 'Graphic designer', avatar:'/img2.png'},
      {name: 'Nina', role: 'web developer', avatar:'/img3.png'},
      {name: 'Groove tech', role: 'Desktop developer', avatar:'/img4.png'},
    ]
  }),
}
