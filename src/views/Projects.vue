...
export default {
  ...
  data: () => ({
    projects : [
      {title: 'Site web ', person :'Thierno', due: '10/10/1987', status:'no'},
      {title: 'Application mobile', person :'Peter', due: '02/07/1990', status:'complete'},
      {title: 'Gestion de stock', person :'Nina', due: '01/05/1987', status:'yes'},
      {title: 'Conception', person :'Hu Node', due: '02/09/1991', status:'up'},
    ]
  }),
  methods: {
    sortBy(prop){
